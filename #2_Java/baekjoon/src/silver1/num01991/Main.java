...
public class Main {
	...
	public static void preTrav(char startNode, BufferedWriter out) throws IOException {
		...
		// 왼쪽 자식 노드가 존재하는 경우 이를 순회하도록 preTrav() 메서드 재귀 호출
		if (leftChild != '.')
			preTrav(leftChild, out);
			
		// 오른쪽 자식 노드가 존재하는 경우 이를 순회하도록 preTrav() 메서드 재귀 호출
		if (rightChild != '.')
	...
	public static void inTrav(char startNode, BufferedWriter out) throws IOException {
		...
		// 왼쪽 자식 노드가 존재하는 경우 이를 순회하도록 inTrav() 메서드 재귀 호출
		if (leftChild != '.')
		...
		// 오른쪽 자식 노드가 존재하는 경우 이를 순회하도록 inTrav() 메서드 재귀 호출
		if (rightChild != '.')
	...
	public static void postTrav(char startNode, BufferedWriter out) throws IOException {
		...
		// 왼쪽 자식 노드가 존재하는 경우 이를 순회하도록 postTrav() 메서드 재귀 호출
		if (leftChild != '.')
			postTrav(leftChild, out);

		// 오른쪽 자식 노드가 존재하는 경우 이를 순회하도록 postTrav() 메서드 재귀 호출
		if (rightChild != '.')
