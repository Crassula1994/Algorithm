...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		// 임무를 수행하는 데 남은 시간을 저장할 변수 remainTime 초기화
		int remainTime = 0;
		
		// 현재 시간이 임무 시작 시간 이전인 경우 임무를 수행하는 데 남은 시간 갱신
		if (curTime < startTime) {
			remainTime = startTime - curTime;
		
		// 현재 시간이 임무 시작 시간 이후인 경우 임무를 수행하는 데 남은 시간 갱신
		} else {
			remainTime = startTime - curTime + 86400;
		}
