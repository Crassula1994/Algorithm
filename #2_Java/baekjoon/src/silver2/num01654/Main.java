...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		// nextToken() 및 parseInt() 메서드를 사용해 입력 받은 각 랜선의 개수를 각 변수에 할당
		int originalCable = Integer.parseInt(st.nextToken());
		int newCable = Integer.parseInt(st.nextToken());
