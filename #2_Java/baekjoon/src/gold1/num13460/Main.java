...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		// boardTilter() 메서드를 호출해 빨간 구슬을 구멍을 통해 빼낼 수 있는 최소 횟수를 변수 minCount에 할당
		int minCount = boardTilter();
		
		// valueOf() 및 write() 메서드를 사용해 빨간 구슬을 구멍을 통해 빼낼 수 있는 최소 횟수를 출력
	...
	public static int boardTilter() {
		...
		// 10번 이하로 움직여 빨간 구슬을 빼낼 수 없는 경우 -1 반환
		return -1;
	}
}